...
- Most control charts are suited to detect large shifts in process mean. EWMA charts and CUSUM charts are sensitive to small shifts in process mean.
...
![](https://github.com/Rmadillo/SCH_R_Training/blob/master/images/controlchartflowchart.png?raw=true)
