...
| *Trend:* Seven or more consecutive points all increasing or all decreasing (though this is usually ineffective\*).  | 
| *Trend:* Seven or more consecutive points all increasing or all decreasing (though this is usually ineffective\*).  | 
...
| You have no expectations that normal day-to-day operations will affect the central tendancy. | You expect that normal day-to-day operations will or are meant to keep the process stable within the bounds of common-cause variation. |
...
EWMA and CUSUM charts aren't "standard" control charts in that the only guideline for detecting special cause variation is a point outside the limits. So while they can't detect special cause variation like control charts, they *can* detect shifts in mean with fewer points than a standard control chart.  
...
- A straight-to-the-point reference/tool for doing run charts in R is Anhoej 2016, [*Run charts with R*](https://cran.r-project.org/web/packages/qicharts/vignettes/runcharts.html).
...
- A straight-to-the-point reference/tool for doing run charts in R is Anhoej 2016, [*Control Charts with qicharts for R*](https://cran.r-project.org/web/packages/qicharts/vignettes/controlcharts.html).
