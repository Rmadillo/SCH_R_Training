...
spc.plot <- function(subgroup, point, mean, sigma, k = 3,
                     ...
                     label.x = "Subgroup", label.y = "Value", band.show = TRUE)
{
...
point.signal <- c(-0.36, -0.25, 1.07, 0.67, -1.07, 0.04, -0.72, 1.82, -1.50, -1.29)
point.signal[11] <- 3.4
...
spc.plot(subgroup.signal, point.signal, mean.signal, sigma.signal) +
