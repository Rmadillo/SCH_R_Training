...
*Figure . Chi-square test between Employee Type and responses to the "My team works well together" question.*  

```{r chisq, fig.height=5}
# Get rid of NAs
both2 = na.omit(both)
...
multnom_both = nnet::multinom(Teamwork ~ EmployeeType, data = both2)
multnom_both
...
*Figure . Proportional odds logistic regression.*  
...
### Test assumptions, not shown yet
