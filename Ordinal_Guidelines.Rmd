...
knitr::opts_chunk$set(echo = FALSE, warning = FALSE, message = FALSE, comment=NA, fig.height = 3, fig.align = "center")
...
# Chi-square
both2_chisq = chisq.test(both2_tab, simulate.p.value = T)
...
*Figure 11. Chi-square test ($\chi^2$ = `r both2_chisq$statistic`, *p* = `r both2_chisq$p.value) and mosaic plot between Employee Type and responses to the "My team works well together" question.*  


```{r mosaicplot, fig.height=5}
...
*Figure 12. Multinomial regression between Employee Type and responses to the "My team works well together" question.*  
...
*Figure 13. Proportional odds logistic regression between Employee Type and responses to the "My team works well together" question.*  
...
# Proportional odds assumption is ok
